...
PLUGIN_NAME  = HomematicCCU
PACKAGE_NAME = enigma2-plugin-extensions-homematicccu
...
# Deploy to Enigma2 box via SSH
# Requires BOX_HOST, BOX_PORT, BOX_USER to be set in .env
install: ipk
	@test -n "$(BOX_HOST)" || (echo "BOX_HOST not set – copy .env.template to .env and fill in values" && exit 1)
